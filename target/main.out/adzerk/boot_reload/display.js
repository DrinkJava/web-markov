...
return (function (p__6294){
var vec__6295 = p__6294;
var attr = cljs.core.nth.call(null,vec__6295,(0),null);
var v = cljs.core.nth.call(null,vec__6295,(1),null);
...
var args6296 = [];
var len__6011__auto___6299 = arguments.length;
var i__6012__auto___6300 = (0);
while(true){
if((i__6012__auto___6300 < len__6011__auto___6299)){
args6296.push((arguments[i__6012__auto___6300]));

var G__6301 = (i__6012__auto___6300 + (1));
i__6012__auto___6300 = G__6301;
continue;
} else {
}
break;
...
var len__6011__auto___6304 = arguments.length;
var i__6012__auto___6305 = (0);
while(true){
if((i__6012__auto___6305 < len__6011__auto___6304)){
args__6018__auto__.push((arguments[i__6012__auto___6305]));

var G__6306 = (i__6012__auto___6305 + (1));
i__6012__auto___6305 = G__6306;
continue;
} else {
}
break;
...
var argseq__6019__auto__ = ((((0) < args__6018__auto__.length))?(new cljs.core.IndexedSeq(args__6018__auto__.slice((0)),(0))):null);
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__6019__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq6303){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq6303));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__6307){
var map__6311 = p__6307;
var map__6311__$1 = ((((!((map__6311 == null)))?((((map__6311.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6311.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6311):map__6311);
var data = map__6311__$1;
var message = cljs.core.get.call(null,map__6311__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__6311__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__6311__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__6313 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__6313,goog.events.EventType.CLICK,((function (G__6313,map__6311,map__6311__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__6313,map__6311,map__6311__$1,data,message,line,file))
);

return G__6313;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__6314){
var map__6318 = p__6314;
var map__6318__$1 = ((((!((map__6318 == null)))?((((map__6318.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6318.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6318):map__6318);
var data = map__6318__$1;
var message = cljs.core.get.call(null,map__6318__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__6318__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__6318__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__6320 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__6320,goog.events.EventType.CLICK,((function (G__6320,map__6318,map__6318__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__6320,map__6318,map__6318__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__6321){
var map__6325 = p__6321;
var map__6325__$1 = ((((!((map__6325 == null)))?((((map__6325.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6325.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6325):map__6325);
var messages = map__6325__$1;
var warnings = cljs.core.get.call(null,map__6325__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__6325__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__6327 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__6327,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),goog.dom.htmlToDocumentFragment(adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__6327,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__6328){
var map__6331 = p__6328;
var map__6331__$1 = ((((!((map__6331 == null)))?((((map__6331.cljs$lang$protocol_mask$partition0$ & (64))) || (map__6331.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__6331):map__6331);
var messages = map__6331__$1;
var warnings = cljs.core.get.call(null,map__6331__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__6331__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__6331,map__6331__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__6331,map__6331__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__6331,map__6331__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__6331,map__6331__$1,messages,warnings,exception))
;
...
}catch (e6334){if((e6334 instanceof Error)){
var __6335 = e6334;
} else {
throw e6334;
